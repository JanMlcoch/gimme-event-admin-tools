...
class Imprintificator {
  ...
  ImprintPoint PSEUDO_DELTA_FUNCTION_RELATION = new ImprintPoint()..value = 1.0..probability = 1.0..valueVariance = 0.1..zeroVariance = 0.1;
...
//      correspondingLinks.add(tagLinks);
      ...
      if (links[tags[i]] != null) {
        correspondingLinks.add(links[tags[i]]..points[tags[i]] = PSEUDO_DELTA_FUNCTION_RELATION);
      }
    }
